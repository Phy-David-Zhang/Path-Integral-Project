...
of the most powerful but complicated advanced physical theory ever
existed. And, I was one of the many victims of this complication.
...
(where :math:`p=0`) and the greatest negative value :math:`E=-m` (where
:math:`p=0`). Thus, a classical particle can have either positive or
