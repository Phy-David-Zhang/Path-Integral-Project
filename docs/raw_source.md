...
!! This context will require knowledge on Lagrangian dynamics of fields. If you have not yet cover that in your previous learning, you will find [Lagrangian Form of Fields](@waiting) helpful.
...
!! To understand this section, you at least need to know [some very basic Differential Geometry](../../Background/Basic%20Differential%20Geometry) and [basic Linear Algebra](../../Background/Basic%20Linear%20Algebra).
